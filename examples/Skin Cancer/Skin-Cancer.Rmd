...
skin_cancer_path <- here("development/skin_cancer/")
...
model_checkpoint <- callback_model_checkpoint(filepath = "development/skin_cancer/skin_cancer.h5",
...
```{r}
skin_cancer_model <- load_model_hdf5("development/skin_cancer/skin_cancer.h5")
...
```{r}
set.seed(1234)
sample_test_images <- sample(list.files(test_path, full.names = TRUE, recursive = TRUE), 5)

skin_cancer_explanations <- skin_cancer_explainer$explain(
